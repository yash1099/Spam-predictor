...
history = model.fit(X_train, y_train, epochs=19, batch_size=1,validation_data=(X_val, y_val))
...
def survival():
    ...
    n_siblings_spouses = st.select_slider('N_siblings/spouses',0,3)
